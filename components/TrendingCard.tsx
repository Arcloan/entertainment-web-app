  ...
  return (
    <div key={item.id} className="relative group cursor-pointer min-w-[240px] flex-shrink-0 bg-midnightBlue rounded-lg overflow-hidden">
      ...
      <div className="hidden group-hover:grid absolute w-full h-[230px] rounded-lg top-0 left-0 bg-black/50">
        <button className="absolute place-self-center text-white flex items-center gap-4 py-2 px-4 rounded-full bg-white/30 hover:cursor-pointer"><Image src="/icon-play.svg" alt="" width={32} height={32}/><p>Play</p></button>
      </div>
      <div className="p-2">
